...
import requests
import pandas as pd
from variables import team_dictionary, month_list, month_dictionary
    ...
    for month, page in month_link_array:
        ...
        for l, d in zip(box_link_array, all_dates):
            for link, date in zip(l, d):
                ...
                # stat_df.to_csv(f'Season({season}).csv', line_terminator='\n', index=False) #uncomment to save the results every game
...
season20_21 = 'https://www.basketball-reference.com/leagues/NBA_2021_games.html' #2020-21
